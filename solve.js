...
let ... = ... ; // write variable name and values both */
  ...
  let firstName = "John";  //variable name is firstName
  let lastName = "Doe" //variable value is "Doe" 
  let age = 35 ; //variable name is age, variable value is 35 
...
/*7. The <button> element should do something when someone clicks on it. Try to fix it!
     ...
     //The answer is given in the HTML file.
